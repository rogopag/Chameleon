<?php $banner = get_post_meta($post->ID, 'banner', true); if($banner==null) $banner = 'istituzionale.jpg';  ?>

<div id="category-name" style="background: url(http://195.103.90.62/wp-content/themes/Chameleon/images/<?php echo $banner; ?>)" >
