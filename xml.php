...
if ( !defined('ABSPATH') && file_exists( dirname(__FILE__) . '/../../plugins/nextgen-gallery/ngg-config.php' ) ) 
{
	require_once( dirname(__FILE__) . '/../../plugins/nextgen-gallery/ngg-config.php' );
}
else
{
	echo "You should have nextgen-gallery installed in plugins folder to run this code!";
}
