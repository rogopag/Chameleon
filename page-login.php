		...
		<div class="entry post clearfix">							
			...
			<div id="et-login">
				<div class='et-protected'>
					...
					<p class='et-registration'><?php esc_html_e('Non sei registrato?','Chameleon'); ?> <a href='<?php echo site_url('wp-login.php?action=register', 'login_post'); ?>'><?php esc_html_e('Registrati ora!','Chameleon'); ?></a></p>
				</div> <!-- .et-protected -->
			</div> <!-- end #et-login -->
