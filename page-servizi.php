			...
			<div id="et_pt_blog">
				...
				<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					...
					<div class="et_pt_blogentry clearfix">
						<h2 class="et_pt_title_picc"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
						...
						<?php if ( $thumb <> '' && !$et_ptemplate_showthumb ) { ?>
							<div class="et_pt_thumb_picc alignleft">
								<?php print_thumbnail($thumb, $thumbnail["use_timthumb"], $titletext, $width, $height, $classtext); ?>
						...
						<?php if (!$et_ptemplate_blogstyle) { ?>
							...
							<a href="<?php the_permalink(); ?>" class="readmore"><span><?php esc_html_e('Continua','Chameleon'); ?></span></a>
						<?php } else { ?>
							<?php
								global $more;
								$more = 0;
